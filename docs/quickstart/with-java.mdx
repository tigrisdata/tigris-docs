...
guide will get you up and running locally as quickly as possible using Java.
...
and registered the schema with Tigris based on the three collection models.
