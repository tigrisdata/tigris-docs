...
This guide will get you up and running with a RESTful web application that
uses Tigris as the backend.
...
an e-commerce use case - this is just one of many use cases for how you
could interact with Tigris!
