...
<ProtoServiceMethod
  ...
  method={{
    ...
    requestFullType: "DescribeDatabaseRequest",
    requestStreaming: false,
    responseType: "DescribeDatabaseResponse",
    responseLongType: ".DescribeDatabaseResponse",
    responseFullType: "DescribeDatabaseResponse",
    responseStreaming: false,
    options: {
      "google.api.http": {
        rules: [
...
<ProtoServiceMethod
  ...
  method={{
    ...
    requestFullType: "DescribeCollectionRequest",
    requestStreaming: false,
    responseType: "DescribeCollectionResponse",
    responseLongType: ".DescribeCollectionResponse",
    responseFullType: "DescribeCollectionResponse",
    responseStreaming: false,
    options: {
      "google.api.http": {
        rules: [
...
<ProtoServiceMethod
  ...
  method={{
    ...
    requestFullType: "StreamRequest",
    requestStreaming: false,
    responseType: "StreamResponse",
    responseLongType: ".StreamResponse",
    responseFullType: "StreamResponse",
    responseStreaming: true,
    options: {
      "google.api.http": {
        rules: [
...
<ProtoMessage
  ...
  message={{
    ...
    fullName: ".DescribeCollectionResponse",
    description:
...
<ProtoMessage
  ...
  message={{
    ...
    fullName: ".DescribeDatabaseRequest",
    description: "",
    hasExtensions: false,
    hasFields: true,
    hasOneofs: false,
...
<ProtoMessage
  ...
  message={{
    ...
    fullName: ".DescribeDatabaseResponse",
    description:
    ...
    fields: [
      ...
      },
      {
        ...
        fullType: "CollectionDescription",
        ismap: false,
        isoneof: false,
        oneofdecl: "",
        defaultValue: "",
